...
| Caio Antonio Araújo Garcia de Almeida         | Correção de typos e erros ortográficos na documentação do projeto, revisão e padronização de textos.                                                                                                 | https://gitlab.com/gces-ej/ej-application/-/merge_requests/31–                                                                                                                                     | Melhoria na qualidade e legibilidade da documentação através de correções textuais e padronização da linguagem.                                                                                                                                                                                                                                                                                                                   |
...
| Uires Carlos de Oliveira         |    Criação da issue para padronização dos campos Cidade, País e Etnia no perfil      - Criação da issue para máscara e validação automática da Data de Nascimento no perfil                                                                                                                                |  https://gitlab.com/gces-ej/ej-application/-/work_items/57                                                                                                                                   |                                                                                                                                                                                                                                                                                                                   |
| Victor Augusto de Sousa Câmara|          Otimizar a performance de ej_clusters movendo o cálculo pesado de views.py para processamento assíncrono em segundo plano.   |[issue](https://gitlab.com/gces-ej/ej-application/-/issues?show=eyJpaWQiOiI3OCIsImZ1bGxfcGF0aCI6ImdjZXMtZWovZWotYXBwbGljYXRpb24iLCJpZCI6MTc3MzQzNDI0fQ%3D%3D)          | A execução síncrona de algoritmos de clusterização no arquivo src/ej_clusters/views.py bloqueia o servidor e causa timeouts em grandes volumes de dados. O objetivo é migrar essa lógica para tarefas assíncronas (Celery), permitindo que a interface responda imediatamente enquanto o cálculo ocorre em background.                                                                                                                                                                                                                                                                                                                  |
| Victor Pontual Guedes Arruda Nóbrega |              Correções estruturais, ajustes de permissões, integração de novas rotas e manutenção de testes automatizados.                                                                                                                            |        [Issue #54](https://gitlab.com/gces-ej/ej-application/-/issues/54)                                                                                                                            |           um problema recorrente de erros nos testes é a falta de refatoração de testes para condizer com a realidade atual da função testada                                                                                                                                                                                                                                                                                                |
