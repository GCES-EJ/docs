...
| **João Filipe de Oliveira Souza**          | [ej-users] Estender Modelo User para Federação de Identidades.                                                                                                              | [Issue #59](https://gitlab.com/gces-ej/ej-application/-/issues/59)                                                                                                        | Início da implementação da nova arquitetura de autenticação do EJ, dando seguimento à proposta do Giovanni.                                                                                                              |
...
| **Uires Carlos de Oliveira**              |    Configuração e inicialização do SonarQube localmente (Ubuntu)                                                                                                                                                                          |                                                                                                                                                                           |                                                                                                                                                                                                                           |
