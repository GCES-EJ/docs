...
| Caio Antonio Araújo Garcia de Almeida | Criação de issue para validação de senha forte. Implementação da validação de senha forte (>= 8 caracteres, letra maiúscula e número). | [Issue #47](https://gitlab.com/gces-ej/ej-application/-/issues/47), [MR #27](https://gitlab.com/gces-ej/ej-application/-/merge_requests/27) | Definição clara dos critérios de senha forte no projeto e implementação válida cobrindo tamanho mínimo, presença de maiúscula e número. |
| Felipe Matheus Ribeiro Lopes              | Em colaboração com Yan Lucas e Victor Camara, realizamos uma análise da falha no pipeline de CI/CD e criação de issue para a correção.| [Issue #50](https://gitlab.com/gces-ej/ej-application/-/issues/50) |Contribuição focada em QA e documentação de erros na pipeline |
...
| Victor Augusto de Sousa Câmara | Em colaboração com Felipe Matheus e yan Lucas, realizamos uma análise da falha no pipeline de CI/CD e criação de issue para a correção.                                                                                                                   | [Issue #50](https://gitlab.com/gces-ej/ej-application/-/issues/50)                                                                                                   | Foco em erros da pipeline do projeto                                                                     |
...
| Yan Guimarães         | Em colaboração com Felipe Matheus e Victor Câmara, realizamos uma análise da falha no pipeline de CI/CD e criação de issue para a correção.| [Issue #50](https://gitlab.com/gces-ej/ej-application/-/issues/50) |Contribuição focada em QA e documentação de erros na pipeline |
